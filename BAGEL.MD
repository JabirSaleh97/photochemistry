...
gmolden hf.molden
```
Now switch to `Dens. Mode`, choose a contour using `Space` button (e.g. 0.006) and then select the orbital from a window that appears after pressing `Orbital` button.
