...
![Herzberg-Teller coupling](assets/HT.gif){:style="float: right;margin-right: 7px;margin-top: 7px;"} A schematic taken form [Kundu et al.](https://pubs.acs.org/doi/10.1021/acs.jpcb.2c00846) showing the two potential energy surfaces along a vibrational coordinate q and the initially equilibrated densities for absorption and emission spectra.
